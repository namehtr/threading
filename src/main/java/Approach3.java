...
public class Approach3 implements Runnable{
    private static final String DB_URL = "jdbc:mysql://localhost:3306/testdb";
    private static final String USER = "ruchirthaman";
    private static final String PASS = "password";
    private int userId;
    public Approach3(int userId){
        this.userId = userId;
    }
    public void run() {
        try {
            ...
            String selectForUpdate = "SELECT * FROM seats WHERE movieId = 1 AND userId IS NULL ORDER BY id LIMIT 1 FOR UPDATE SKIP LOCKED";
    ...
    public static void main(String[] args) {
        try {
            ...
            for(int i=1;i<=116;i++) {
                Approach3 myRunnable = new Approach3(i);
